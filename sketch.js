...
//IMAGE 1 WHICH IS NOT SHOWING
aladin = createSprite(windowWidth/2,windowHeight/2+250,10,10)
aladin.addImage(aladinImg1)

//IMAGE 2 WHICH IS NOT SHOWING
yasmine = createSprite(windowWidth/2,windowHeight/2+250,10,10)
yasmine.addImage(aladinImg2)

//IMAGE 3 WHICH IS NOT SHOWING
point1 = createSprite(500,500,40,40)
